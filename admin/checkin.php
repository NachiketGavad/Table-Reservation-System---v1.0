	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				<a class = "btn btn-success" href = "home.php"><span class = "badge"><?php echo $f_p['total']?></span> Pendings</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo "<label style = 'color:#00ff00;'>".date("M d, Y", strtotime($fetch['date']))."</label>"?></td>
